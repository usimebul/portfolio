            ...
            <Section>
                ...
                <P css={css`
                  ...
                  min-width: 37em`
                    ...
                    <Span>I'm a Web Front-End Developer has experiences to develop cryptographic module, PKI solutions,
                        and user authentication services. I'm aiming to be Front-End centric Full-Stack Developer and
                        expanding my tech stack to server-side works (server, database, and infrastructure)</Span>
                    <Span>I'm a Logician (INTP), problem solver, challenger, and positive person. I like to watch TV
                        shows,
                    ...
                    <Span>I'm interested in UI design, effects, animations and creating intuitive, dynamic user
                        experiences. </Span>
                </P>
            </Section>
            <Section>
