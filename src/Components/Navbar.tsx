...
function Navbar() {
    ...
    return <Menu>
        ...
        <Nav>
            <NavItem to="/">
                <motion.div whileHover={{color: theme.textColor.highlight}}>Home</motion.div>
            </NavItem>
            <NavItem to="/about">
                <motion.div whileHover={{color: theme.textColor.highlight}}>About</motion.div>
            </NavItem>
            <NavItem to="/skills">
                <motion.div whileHover={{color: theme.textColor.highlight}}>Skills</motion.div>
            </NavItem>
            <NavItem to="/work">
                <motion.div whileHover={{color: theme.textColor.highlight}}>Work</motion.div>
            </NavItem>
            <NavItem to="/contact">
                <motion.div whileHover={{color: theme.textColor.highlight}}>Contact</motion.div>
            </NavItem>
        </Nav>
        <SocialLinks>
            <a>
